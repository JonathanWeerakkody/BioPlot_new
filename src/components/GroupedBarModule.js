  ...
  return (
    <div className="bar-chart-module">
      <div className="module-header">
        ...
        <p>Create a bar chart with grouped bars for comparing multiple data series across categories</p>
      </div>

      <div className="module-content">
        <div className="input-section">
          <DataInput onDataSubmit={handleDataSubmit} graphType="groupedBar" />
        </div>
        ...
        <div className="options-section">
          ...
          <div className="options-grid">
            ...
            <div className="option-group">
              <label htmlFor="groupSpacing">Group Spacing</label>
              <input
                type="range"
                id="groupSpacing"
                name="groupSpacing"
                ...
                max="0.5"
                step="0.05"
                value={chartOptions.groupSpacing}
                onChange={handleOptionChange}
              />
              <span>{chartOptions.groupSpacing}</span>
            </div>
        ...
        <div className="preview-section">
          ...
          <div className="chart-preview">
            {chartImage ? (
              <img src={chartImage} alt="Grouped Bar Chart" />
            ) : (
